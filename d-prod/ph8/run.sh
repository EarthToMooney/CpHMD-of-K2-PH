...
#SBATCH --job-name=dPH8             # Assign an short name to your job
...
srun --mpi=pmi2 sander.MPI -O -i md.mdin -p 2lko.parm7 -c 2lko.equil.rst7 -cpin 2lko.equil.cpin -o 2lko.production_pH8.mdout -cpout 2lko.production_pH8.cpout -r 2lko.production_pH8.rst7 -x 2lko.production_pH8.nc -cprestrt 2lko.production_pH8.cpin ## Run the job
