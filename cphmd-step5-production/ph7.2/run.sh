...
#SBATCH --job-name=3ph7.2             # Assign an short name to your job
#SBATCH --nodes=2                    # Number of nodes you require
#SBATCH --ntasks=36                 # Total # of tasks across all nodes
...
srun --mpi=pmi2 sander.MPI -O -i md.mdin -p 2lko.parm7 -c 2lko.equil.rst7 -cpin 2lko.equil.cpin -o 2lko.p.mdout -cpout 2lko.p.cpout -r 2lko.p.rst7 -x 2lko.p.nc -cprestrt 2lko.p.cpin ## Run the job
