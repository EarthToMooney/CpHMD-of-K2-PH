...
#SBATCH --job-name=2PH8             # Assign an short name to your job
#SBATCH --nodes=1                    # Number of nodes you require
#SBATCH --ntasks=12                 # Total # of tasks across all nodes
...
sander.MPI -O -i md.mdin -p 2lko.parm7 -c 1_heat.rst7 -cpin 2lko.cpin -o 2lko.equil.mdout -cpout 2lko.equil.cpout -r 2lko.equil.rst7 -x 2lko.equil.nc -cprestrt 2lko.equil.cpin ## Run the job
