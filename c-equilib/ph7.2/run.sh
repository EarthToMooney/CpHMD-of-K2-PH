...
#SBATCH --job-name=7.2             # Assign an short name to your job
...
srun --mpi=pmi2 sander.MPI -O -i md.mdin -p 2lko.parm7 -c b_heat.rst7 -cpin 2lko.cpin -o 2lko.equil.mdout -cpout 2lko.equil.cpout -r 2lko.equil.rst7 -x 2lko.equil.nc -cprestrt 2lko.equil.cpin ## Run the job
