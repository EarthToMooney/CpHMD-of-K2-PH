...
#SBATCH --job-name=3PH7             # Assign an short name to your job
...
srun --mpi=pmi2 sander.MPI -O -i md.mdin -p 2lko.parm7 -c 2lko.equil.rst7 -cpin 2lko.equil.cpin -o 2lko.production_pH_7.mdout -cpout 2lko.production_pH_7.cpout -r 2lko.production_pH_7.rst7 -x 2lko.production_pH_7.nc -cprestrt 2lko.production_pH_7.cpin ## Run the job
