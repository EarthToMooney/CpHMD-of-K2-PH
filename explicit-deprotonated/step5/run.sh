...
#SBATCH --job-name=ion3p             # Assign an short name to your job
...
## Run the job
srun --mpi=pmi2 pmemd.MPI -O -i prod.mdin -o p.mdout -p 2lko.parm7 -c eq.rst7 -r p.rst7 -x p.nc -ref eq.rst7 
